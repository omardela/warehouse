...
export function CreditNoteForm({ action, invoiceId, supplierName, status, lines }: CreditNoteFormProps) {
        ...
        <div style={{ maxWidth: "640px", margin: "80px auto", textAlign: "center" }}>
          <div style={{ background: "#171f33", border: "1px solid #222a3e", borderRadius: "12px", padding: "40px" }}>
            ...
            <p style={{ fontSize: "13px", color: "#8c90a2", margin: "0 0 24px" }}>
              The credit note has been saved as a draft. Confirm it to record the stock return.
            </p>
            <div style={{ display: "flex", gap: "12px", justifyContent: "center" }}>
              <Link
                href={`/dashboard/purchases/credit-notes/${state.creditNoteId}`}
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px", flexWrap: "wrap", gap: "12px" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
              ...
              <Link href={`/dashboard/purchases/${invoiceId}`} style={{ color: "#8c90a2", textDecoration: "none", fontSize: "13px" }}>
            ...
            <p style={{ fontSize: "13px", color: "#8c90a2", marginTop: "4px" }}>
              Supplier: {supplierName} · Invoice Status: {status}
            </p>
          </div>
          <Link
            href={`/dashboard/purchases/${invoiceId}`}
