...
import { confirmPurchaseCreditNoteAction } from "../actions";
import { CancelCreditNoteButton } from "./CancelCreditNoteButton";
...
export default async function PurchaseCreditNoteDetailPage({ params }: PageProps) {
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "24px", flexWrap: "wrap", gap: "12px" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "6px" }}>
              <Link href="/dashboard/purchases/credit-notes" style={{ color: "#8c90a2", textDecoration: "none", fontSize: "13px" }}>
          ...
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
            {isDraft && (
              <>
                ...
                <CancelCreditNoteButton creditNoteId={creditNote.id} />
              </>
            )}
          </div>
        </div>
            ...
            <div style={{ background: "#171f33", border: "1px solid #222a3e", borderRadius: "10px", padding: "20px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                <div>
                  ...
                  {creditNote.originalInvoice.supplier ? (
                    <Link href={`/dashboard/suppliers/${creditNote.originalInvoice.supplier.id}`} style={{ color: "#6b9fff", textDecoration: "none", fontSize: "14px", fontWeight: 500 }}>
                      {creditNote.originalInvoice.supplier.name}
                    </Link>
                  ) : (
                ...
                <div>
                  ...
                  <Link href={`/dashboard/purchases/${creditNote.originalInvoice.id}`} style={{ color: "#6b9fff", textDecoration: "none", fontSize: "13px", fontWeight: 500, fontFamily: "monospace" }}>
