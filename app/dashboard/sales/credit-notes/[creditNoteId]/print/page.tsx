...
export default async function SalesCreditNotePrintPage({ params }: PageProps) {
  ...
  const customer = creditNote.originalInvoice.customer;
    ...
    <PrintPageShell dir={dir} printLabel={t.print}>
      <div className="doc-header">
        ...
        <div className="doc-title-block">
          <div className="doc-title">{t.titles.salesCreditNote}</div>
      ...
      <div className="doc-parties">
        <div className="doc-party">
          <div className="doc-party-label">{t.parties.customer}</div>
          {customer ? (
            <>
              <div className="doc-party-name">{customer.name}</div>
              {customer.email && <div className="doc-party-detail">{customer.email}</div>}
