  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0b1326", padding: "24px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        {/* Table */}
        <style>{`
          .customer-row:hover { background: #1a2237 !important; }
          .customer-row-archived:hover { background: rgba(140,144,162,0.07) !important; }
        `}</style>
        <div
          style={{
            background: "#171f33",
                ...
                {customersWithBalance.length === 0 ? (
                  ...
                  customersWithBalance.map((customer) => {
                    ...
                    return (
                      <tr
                        key={customer.id}
                        className={isArchived ? "customer-row-archived" : "customer-row"}
                        style={{
                      ...
                      >
                        <td style={{ padding: "12px 16px" }}>
                          ...
                          {customer.address && (
                            <div style={{ fontSize: "11px", color: "#4a5068", marginTop: "2px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", maxWidth: "220px" }}>
                              {customer.address}
                            </div>
                          )}
                        </td>
                        <td style={{ padding: "12px 16px", color: isArchived ? "#4a5068" : "#8c90a2" }}>
                          {customer.phone ?? <span style={{ color: "#4a5068" }}>—</span>}
                        </td>
                        <td style={{ padding: "12px 16px", color: isArchived ? "#4a5068" : "#8c90a2" }}>
                          {customer.email ?? <span style={{ color: "#4a5068" }}>—</span>}
                        </td>
                        <td style={{ padding: "12px 16px" }}>
                          <span
                            style={{
                              fontWeight: 600,
                              color: isArchived ? "#4a5068" : balance > 0 ? "#f59e0b" : "#62df7d",
                              fontSize: "13px",
                            }}
                          >
